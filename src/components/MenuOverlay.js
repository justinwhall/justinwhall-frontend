        ...
        <nav id="nav" className={this.state.open ? 'in' : null}>
          <div className="menu-main-nav-menu-container">
            <ul id="primary-menu" className="menu">
              ...
              <li><Link to="/web-development-blog/">BLOG</Link></li>
              <li><a target="_blank" href="http://windsorup.com/">MAINTENANCE</a></li>
              <li><a targset="_blank" href="https://www.littlebot.io">PLUGINS</a></li>
